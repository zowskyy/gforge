...
def _weapon_tres(manifest: CreatorManifest, name: str, stats: dict) -> bytes:
    ...
    lines = [
        ...
        f"pellet_count = {stats['pellet_count']}",
        f"fire_rate = {stats['fire_rate']}",
        f"magazine_size = {stats['magazine_size']}",
        f"reload_time = {stats['reload_time']}",
        "",
    ]
...
# Fixed weapon/ability balance — not manifest-derived (no WeaponParameters/
