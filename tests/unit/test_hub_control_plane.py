...
def test_exact_two_control_plane_files() -> None:
    assert HUB_METADATA_FILES == (RUN_RECORDS_RELATIVE, SPOKE_LEDGER_RELATIVE)
...
def test_validate_hub_metadata_dir_accepts_both_exact_files(tmp_path: Path) -> None:
